...
public class SimpleLinkedList<T> implements Iterable<T> {
    ...
    public void reverse() {
        ...
        /* The runtime for this algorithm is O(N) because it immediately goes to the "begin" pointer (which
         * has been switched with the "end") then touches each node one time to switch the next and previous pointers
         *
         * A way to make the reverse() method O(1) would be to add a case to the Iterator class where if some boolean
         * 'reverse' is true, then it iterates through using the 'previous' pointer in place of the next pointer.
         * Then, when the reverse() method is called, it sets 'reverse' to true and jsut switches the beginmarker and
         * endmarker pointers.
         */
