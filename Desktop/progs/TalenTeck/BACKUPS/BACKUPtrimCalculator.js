...
function drawGraph(trimValues) {
    ...
    $(".turnoverReduction").html("Turnover Reduction " + "<p style='font-size:20px;font-weight:bold;'>10% </p>");
    $("#gains").html("Top Line Gains " + "<p style='margin-top:4px;color:#E87506;font-weight:bold;font-size:15px;'>$" + addCommas(trimValues["10%topLineGains"].toFixed(0)) + "</p>");   
    $("#costSavings").html("Cost Savings " + "<p style='margin-top:4px;color:#348CA2;font-weight:bold;font-size:15px;'>$" + addCommas(trimValues["10%costSavings"].toFixed(0)) + "</p>");
    $(".totalEBITDA").append("Total EBITDA Improvement "+ "<p style='font-size:20px;font-weight:bold;'>$" + addCommas(trimValues["10%EBITDAImpact"].toFixed(0)) + "</p>");    
