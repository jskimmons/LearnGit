...
/**
 * Servlet implementation class GetPeriodListApplicant
 */
@WebServlet("/GetPeriodListApplicant")
public class GetPeriodListApplicant extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetPeriodListApplicant() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PeriodListApplicant returnList = new PeriodListApplicant();
