...
/**
 * Servlet implementation class GetPeriodListSeparation
 */
@WebServlet("/GetPeriodListSeparation")
public class GetPeriodListSeparation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetPeriodListSeparation() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PeriodListSeparation returnList = new PeriodListSeparation();
