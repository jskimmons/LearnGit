...
/**
 * Servlet implementation class GetPeriodListTenure
 */
@WebServlet("/GetPeriodListTenure")
public class GetPeriodListTenure extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetPeriodListTenure() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PeriodListTenure returnList = new PeriodListTenure();
